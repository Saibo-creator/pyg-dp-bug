...
class FakeHeteroDataset(InMemoryDataset):
	...
	fix_num_channels=False,
        **kwargs,
        ...
        self.num_channels = [
            get_num_channels(avg_num_channels, fix_num_channels) for _ in self.node_types
        ]
...
def get_num_channels(num_channels, fix_num_channels) -> int:
